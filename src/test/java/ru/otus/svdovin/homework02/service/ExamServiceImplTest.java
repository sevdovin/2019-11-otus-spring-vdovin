...
public class ExamServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        examServiceImpl = new ExamServiceImpl(questionLoaderImpl, ioService, settings);
    }

    @Test
    public void examineTest() throws QuestionsLoadingFailedException {
        given(settings.getSuccessRate()).willReturn(3);
        ...
        verify(settings, times(1)).getSuccessRate();
