...
class BookRepositoryImplTest {
    ...
    private static final long TEST_BOOK_ID_NOT_EXISTS = 7;
    private static final String TEST_BOOK_NAME_NOT_EXISTS = "Book 7";
    ...
    private static final int TEST_GENRE_ID_BOOK_COUNT = 2;
    private static final int BOOKS_COUNT_INT = 6;
    private static final long BOOKS_COUNT_LONG = 6;
