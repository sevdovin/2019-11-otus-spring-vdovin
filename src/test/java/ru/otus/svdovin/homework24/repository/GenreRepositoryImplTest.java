...
class GenreRepositoryImplTest {
    ...
    private static final long GENRES_COUNT_LONG = 5;
    private static final int GENRES_COUNT_INT = 5;
    private static final long GENRE_ID_EXIST = 4;
    private static final long GENRE_ID_NOT_EXIST = 6;
    private static final String GENRE_NAME_EXISTS = "Genre 4";
    private static final String GENRE_NAME_NOT_EXISTS = "Genre 6";
