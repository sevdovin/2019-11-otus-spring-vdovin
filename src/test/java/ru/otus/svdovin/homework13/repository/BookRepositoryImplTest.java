...
class BookRepositoryImplTest {
    ...
    private static final String BOOK_ID_EXIST = "idBook1";
    ...
    private static final String BOOK_ID_NOT_EXIST = "idBook6";
    ...
    void shouldInsertBook() {
        val book = Book.builder()
                ...
                .build();
        String newId = bookRepository.save(book).getBookId();
        book.setBookId(newId);
        val actual = bookRepository.findById(newId).orElse(null);
    ...
    void shouldUpdateBook() {
        val book1 = bookRepository.findById(BOOK_ID_EXIST).orElse(null);
        assertNotNull(book1);
    ...
    void shouldDeleteBook() {
        ...
        bookRepository.deleteById(BOOK_ID_EXIST);
        val book2 = bookRepository.findById(BOOK_ID_EXIST).orElse(null);
    ...
    void shouldFindBookById() {
        Optional<Book> book = bookRepository.findById(BOOK_ID_EXIST);
    ...
    void testGetBooksByAuthorId() {
        List<Book> bookList = bookRepository.findByAuthorsAuthorId(TEST_AUTHOR_ID);
    ...
    void shouldCheckExistById() {
        assertAll("Существование id книги",
                () -> assertThat(bookRepository.existsById(BOOK_ID_EXIST)).isEqualTo(true),
                () -> assertThat(bookRepository.existsById(BOOK_ID_NOT_EXIST)).isEqualTo(false)
        );
    }
