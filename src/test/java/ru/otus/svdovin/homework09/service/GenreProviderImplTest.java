...
class GenreProviderImplTest {
    ...
    void shouldCeateGenre() {
        ...
        Mockito.when(genreRepository.insert(genre)).thenReturn(NEW_GENRE_ID);
    ...
    void shouldReturnExpectedGenreById() {
        Genre genre = new Genre(NEW_GENRE_ID, NEW_GENRE_NAME);
        Mockito.when(genreRepository.getById(NEW_GENRE_ID)).thenReturn(Optional.of(genre));
    ...
    void shouldReturnExpectedGenreByName() {
        ...
        list.add(genre);
        Mockito.when(genreRepository.getByName(NEW_GENRE_NAME)).thenReturn(list);
    ...
    void shouldReturnAllGenres() {
        ...
        List<Genre> list = new ArrayList<>();
        list.add(genre);
        Mockito.when(genreRepository.getAll()).thenReturn(list);
    ...
    void shouldCheckExistByName() {
        Mockito.when(genreRepository.existsByName(GENRE_NAME_EXISTS)).thenReturn(true);
        Mockito.when(genreRepository.existsByName(GENRE_NAME_NOT_EXISTS)).thenReturn(false);
