...
class CommentProviderImplTest {
    ...
    void shouldCeateComment() {
        ...
        Mockito.when(commentRepository.insert(comment)).thenReturn(NEW_COMMENT_ID);
    ...
    void shouldReturnExpectedCommentById() {
        Comment comment = new Comment(NEW_COMMENT_ID, NEW_COMMENT_COMMENT);
        Mockito.when(commentRepository.getById(NEW_COMMENT_ID)).thenReturn(Optional.of(comment));
    ...
    void shouldReturnExpectedCommentsByBookId() {
        ...
        Mockito.when(commentRepository.getByBookId(DEFAULT_BOOK_ID)).thenReturn(comments);
    ...
    void shouldCheckCommentExistsByBookId() {
        Mockito.when(commentRepository.existsByBookId(DEFAULT_BOOK_ID)).thenReturn(true);
        Mockito.when(commentRepository.existsByBookId(DEFAULT_BOOK_ID_NOT_EXISTS)).thenReturn(false);
