...
class AuthorProviderImplTest {
    ...
    void shouldCeateAuthor() {
        ...
        Mockito.when(authorRepository.insert(author)).thenReturn(NEW_AUTHOR_ID);
    ...
    void shouldReturnExpectedAuthorById() {
        Author author = new Author(NEW_AUTHOR_ID, NEW_AUTHOR_NAME);
        Mockito.when(authorRepository.getById(NEW_AUTHOR_ID)).thenReturn(Optional.of(author));
    ...
    void shouldReturnExpectedAuthorByName() {
        ...
        list.add(author);
        Mockito.when(authorRepository.getByName(NEW_AUTHOR_NAME)).thenReturn(list);
    ...
    void shouldReturnAllAuthors() {
        ...
        List<Author> list = new ArrayList<>();
        list.add(author);
        Mockito.when(authorRepository.getAll()).thenReturn(list);
    ...
    void shouldCheckExistByName() {
        Mockito.when(authorRepository.existsByName(AUTHOR_NAME_EXISTS)).thenReturn(true);
        Mockito.when(authorRepository.existsByName(AUTHOR_NAME_NOT_EXISTS)).thenReturn(false);
