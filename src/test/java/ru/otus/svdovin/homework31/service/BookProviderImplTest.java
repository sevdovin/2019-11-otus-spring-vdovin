...
import ru.otus.svdovin.homework31.dto.BookDto;
import ru.otus.svdovin.homework31.repository.BookRepository;
...
class BookProviderImplTest {
    ...
    void shouldReturnAllBooks() {
        ...
        List<BookDto> listBooks = bookProvider.getBookAll();
        assertAll("Книга",
                () -> assertThat(listBooks.size()).isEqualTo(1),
                () -> assertThat(listBooks.get(0)).isEqualToComparingFieldByField(book)
        );
